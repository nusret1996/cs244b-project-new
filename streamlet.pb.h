...
class Block final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:Block) */ {
 public:
...
inline ::Block* Proposal::_internal_mutable_block() {
  ...
  if (_impl_.block_ == nullptr) {
    auto* p = CreateMaybeMessage<::Block>(GetArena());
...
inline void Proposal::set_allocated_block(::Block* value) {
  ...
  if (message_arena == nullptr) {
    delete reinterpret_cast<::Block*>(_impl_.block_);
  }

  if (value != nullptr) {
    ::google::protobuf::Arena* submessage_arena = reinterpret_cast<::Block*>(value)->GetArena();
